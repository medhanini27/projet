...
return "patient non trouve";
}




void afficher_rendezvousA(GtkWidget *liste)
{
		...
		{if(strcmp(id2,d)==0)
{
	...
	gtk_list_store_set (store, &iter, JOUR, jour, MOIS, mois, ANNE, anne,HEURE,heure,CLIENT,convertir(id),SALLE,salle, -1); 
		}
		}
		}
		fclose(f);
